package parser;
// Generated from parser/SVM.g4 by ANTLR 4.13.1
...
public class SVMParser extends Parser {
	...
	public static final int
		...
		POP=18, POPR=19, BRANCH=20, BRANCHEQ=21, BRANCHLESSEQ=22, BRANCHLESS=23, 
		JUMPSUB=24, RETURNSUB=25, HALT=26, REG=27, LABEL=28, NUMBER=29, WHITESP=30, 
		LINECOMENTS=31, ERR=32;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'push'", "'pushr'", "'pop'", "'popr'", "'b'", "'beq'", "'bleq'", "'blt'", 
			"'jsub'", "'rsub'", "'halt'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"POPR", "BRANCH", "BRANCHEQ", "BRANCHLESSEQ", "BRANCHLESS", "JUMPSUB", 
			"RETURNSUB", "HALT", "REG", "LABEL", "NUMBER", "WHITESP", "LINECOMENTS", 
			"ERR"
		};
	}
	...
	public final AssemblyContext assembly() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 402653168L) != 0)) {
				{
				{
				setState(4);
				instruction();
